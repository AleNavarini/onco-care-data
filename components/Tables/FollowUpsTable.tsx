...
export default function FollowUpsTable({ patientId, followUps: initialFollowUps }: Props) {
    const [followUps, setFollowUps] = useState<FollowUp[]>(initialFollowUps)
    const [editFollowUp, setEditFollowUp] = useState<FollowUp | null>(null)
    const [newModalOpen, setNewModalOpen] = useState<boolean>(false);
    const [editModalOpen, setEditModalOpen] = useState<boolean>(false);

    const addFollowUp = (followUp: FollowUp) => setFollowUps((prevFollowUps) => [...prevFollowUps, followUp])

    const updateFollowUp = (followUp: FollowUp) => {
        setFollowUps((prevFollowUps) => prevFollowUps.map((fu: FollowUp) => {
    ...
    return (
        ...
        >
            ...
            >
                    ...
                    <tr>
                        {
                            ...
                            <>
                                ...
                                <th style={{ textAlign: 'center', verticalAlign: 'middle' }}>Vino</th>
                                <th style={{ textAlign: 'center', verticalAlign: 'middle' }}>Tiene Enfermedad</th>
                                <th style={{ textAlign: 'center', verticalAlign: 'middle' }}>Sitio Recidiva</th>
                                <th style={{ textAlign: 'center', verticalAlign: 'middle' }}>Murio</th>
                                <th style={{ textAlign: 'center', verticalAlign: 'middle' }}>Causa Muerte</th>
                                <th style={{ textAlign: 'center', verticalAlign: 'middle' }}>Observaciones</th>
                            </>
                        }
                ...
                <tbody>
                    {followUps && followUps.length > 0 && followUps.map((followUp: FollowUp) => {
                        ...
                        return (
                            <tr key={followUp.id.toString()}>
                                ...
                                <td style={{ textAlign: 'center', verticalAlign: 'middle' }}>
                                    <Typography fontWeight="md">{getStringForBoolean(followUp.attended)}</Typography>
                                </td>
                                <td style={{ textAlign: 'center', verticalAlign: 'middle' }}>
                                    <Typography fontWeight="md">{getStringForBoolean(followUp.hasDisease)}</Typography>
                                </td>
                                <td style={{ textAlign: 'center', verticalAlign: 'middle' }}>
                                    <Typography fontWeight="md">{followUp.recurrenceSite}</Typography>
                                </td>
                                <td style={{ textAlign: 'center', verticalAlign: 'middle' }}>
                                    <Typography fontWeight="md">{getStringForBoolean(followUp.died)}</Typography>
                                </td>
                                <td style={{ textAlign: 'center', verticalAlign: 'middle' }}>
                                    <Typography fontWeight="md">{followUp.causeOfDeath}</Typography>
                                </td>
                                <td style={{ textAlign: 'center', verticalAlign: 'middle' }}>
                                    <Typography fontWeight="md">{followUp.observations}</Typography>
                                </td>
